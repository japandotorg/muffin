...
export enum UserFlags {
	...
	EarlySupporter = 1 << 9,
    /**
     * User is in a [team](https://discord.com/developers/docs/topics/teams)
     */
	TeamUser = 1 << 10,
    /**
     * Bug Hunter Level 2
    ...
    /**
     * User has been identified as a spammer
     * 
     * @unstable This user flag is currently not documented by Discord but has a known value which we will try to keep upto date
     */
    Spammer = 1 << 20,
    /**
     * User's account has been qurantined based on recent activity
     * 
     * @unstable This user flag is currently not documented by Discord but has a known value which we will try to keep upto date
     */
...
export enum ButtonStyles {
    /** A blurple button | Requires a custom_id */
    Primary = 1,
    /** A grey button | Requires a custom_id */
    Secondary = 2,
    /** A green button | Requires a custom_id */
    Success = 3,
    /** A red button | Requires a custom_id */
    Danger = 4,
    /** A button that navigates to a URL | Requires an URL */
    Link = 5,
}
