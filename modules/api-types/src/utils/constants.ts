 ...
 * Muffin Version 
 */
export const MUFFIN_VERSION = "0.1.0";

/**
 * https://discord.com/developers/docs/reference#user-agent
 */
export const USER_AGENT = `DiscordBot (https://github.com/japandotorg/muffin, v${MUFFIN_VERSION})`;
...
/**
 * This can be modified and used as a proxy
 */
